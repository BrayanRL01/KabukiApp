...
import 'info_perfil_copy_widget.dart' show InfoPerfilCopyWidget;
...
class InfoPerfilCopyModel extends FlutterFlowModel<InfoPerfilCopyWidget> {
  ...
  String? _txtNombreControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '429pa9av' /* Su nombre es requerido. */,
      );
    }

    if (val.length > 30) {
      return FFLocalizations.of(context).getText(
        'zwp582f5' /* El máximo de caracteres es de ... */,
      );
    }
  ...
  String? _txtCorreoControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'r3j8d2bj' /* Su correo electrónico es reque... */,
      );
    }
    ...
    if (!RegExp(kTextValidatorEmailRegex).hasMatch(val)) {
      return FFLocalizations.of(context).getText(
        '09r17jjw' /* Debe ser un correo electrónico... */,
      );
    }
    return null;
  }
  ...
  String? _txtTelefonoControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'jg764qba' /* Su número telefónico es requer... */,
      );
    }
