...
import 'products_home_model.dart';
export 'products_home_model.dart';

class ProductsHomeWidget extends StatefulWidget {
  const ProductsHomeWidget({Key? key}) : super(key: key);

  @override
  _ProductsHomeWidgetState createState() => _ProductsHomeWidgetState();
}

class _ProductsHomeWidgetState extends State<ProductsHomeWidget>
    with TickerProviderStateMixin {
  late ProductsHomeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductsHomeModel());
