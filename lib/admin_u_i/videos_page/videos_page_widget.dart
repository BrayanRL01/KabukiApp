...
class VideosPageWidget extends StatefulWidget {
  const VideosPageWidget({Key? key}) : super(key: key);

  @override
  _VideosPageWidgetState createState() => _VideosPageWidgetState();
}
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'xq9hcxhl' /* Videos de la Aplicación */,
                      ),
                  ...
                  child: StreamBuilder<List<VideosRecord>>(
                    stream: queryVideosRecord(
                      queryBuilder: (videosRecord) =>
                          videosRecord.orderBy('video_name'),
                    ),
