...
import 'producto1_model.dart';
export 'producto1_model.dart';
...
class _Producto1WidgetState extends State<Producto1Widget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Producto1Model());
  }
                  ...
                  children: [
                    Container(
                      ...
                      child: Stack(
                        ...
                        children: [
                          Image.asset(
                            'assets/images/Beauty_Creations_Poreless_Primer.png',
