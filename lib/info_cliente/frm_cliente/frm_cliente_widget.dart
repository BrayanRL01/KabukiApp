...
class _FrmClienteWidgetState extends State<FrmClienteWidget> {
  ...
  void initState() {
    ...
    _model.txtProvinciaController ??= TextEditingController();
    _model.txtProvinciaFocusNode ??= FocusNode();

    _model.txtEdadController ??= TextEditingController();
    _model.txtEdadFocusNode ??= FocusNode();

    _model.txtPielController ??= TextEditingController();
    _model.txtPielFocusNode ??= FocusNode();
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    8.0, 0.0, 8.0, 0.0),
                                child: TextFormField(
                                  controller: _model.txtProvinciaController,
                                  focusNode: _model.txtProvinciaFocusNode,
                                  autofocus: true,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    labelText: 'Provincia',
                                  ...
                                  style:
                                      FlutterFlowTheme.of(context).bodyMedium,
                                  validator: _model
                                      .txtProvinciaControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  style:
                                      FlutterFlowTheme.of(context).bodyMedium,
                                  validator: _model.txtEdadControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    8.0, 30.0, 8.0, 0.0),
                                child: TextFormField(
                                  controller: _model.txtPielController,
                                  focusNode: _model.txtPielFocusNode,
                                  autofocus: true,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                  ...
                                  style:
                                      FlutterFlowTheme.of(context).bodyMedium,
                                  validator: _model.txtPielControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                              Padding(
                  ...
                  children: [
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await FrmClienteRecord.collection
                              .doc()
                              .set(createFrmClienteRecordData(
                                nombre: _model.txtNombreController.text,
                                provincia: _model.txtProvinciaController.text,
                                edad:
                                    int.tryParse(_model.txtEdadController.text),
                                tipoPiel: _model.txtPielController.text,
                                alergias: _model.txtPielController.text,
