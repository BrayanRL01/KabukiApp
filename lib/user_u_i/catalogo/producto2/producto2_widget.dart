...
import 'producto2_model.dart';
export 'producto2_model.dart';

class Producto2Widget extends StatefulWidget {
  const Producto2Widget({Key? key}) : super(key: key);

  @override
  _Producto2WidgetState createState() => _Producto2WidgetState();
}

class _Producto2WidgetState extends State<Producto2Widget> {
  late Producto2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Producto2Model());
  }
