...
import 'videos_page_copy_model.dart';
export 'videos_page_copy_model.dart';

class VideosPageCopyWidget extends StatefulWidget {
  const VideosPageCopyWidget({Key? key}) : super(key: key);

  @override
  _VideosPageCopyWidgetState createState() => _VideosPageCopyWidgetState();
}

class _VideosPageCopyWidgetState extends State<VideosPageCopyWidget> {
  late VideosPageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VideosPageCopyModel());
  }
                      ...
                      StreamBuilder<List<CategoriesRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<CategoriesRecord>
                              ddCategoriesCategoriesRecordList = snapshot.data!;
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    FlutterFlowVideoPlayer(
                                      path: listViewVideosRecord.videoPath,
